...
Requires: clone https://github.com/Horea94/Fruit-Images-Dataset into data/Fruit-Images-Dataset

Example:
  python main.py --all
  python main.py --section bovw
  python main.py --section svm cnn alexnet
"""
